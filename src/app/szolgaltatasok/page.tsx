...
const servicesData = [
    {
        ...
        content: (
            <p className="text-lg text-brand-slate mb-6 leading-loose">
                ...
                <a href="https://www.barum-tyres.com/hu/hu/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/barum.svg" alt="Barum" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>
                ...
                <a href="https://www.falkentyre.com/hu" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/falken.svg" alt="Falken" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>
                ...
                <a href="https://www.kumhotire.com/en/index.do" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/kumho.svg" alt="Kumho" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>

                <a href="https://www.laufenn.com/hu/front/hu_front/index.do" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/laufenn.svg" alt="Laufenn" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>
                ...
                <a href="https://www.nexentire.com/international/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/nexen.svg" alt="Nexen" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>

                <a href="https://www.uniroyal-tyres.com/hu/hu/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/nokian.svg" alt="Nokian Tyres" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>
                ...
                <a href="https://www.taurus-tyres.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/taurus.svg" alt="Taurus" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>

                <a href="https://www.toyotires.eu/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/toyo.svg" alt="Toyo Tires" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>

                <a href="https://www.uniroyal-tyres.com/hu/hu/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/uniroyal.svg" alt="Uniroyal" width={90} height={24} className="w-22.5 h-6 object-contain" />
                </a>
    ...
    },
    {
        ...
        content: (
            <p className="text-lg text-brand-slate mb-6 leading-loose">
                ...
                <a href="https://www.platin-wheels.com/en/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/platin.svg" alt="Platin Wheels" width={90} height={28} className="w-22.5 h-7 object-contain" />
                </a>

                <a href="https://momo.com/en-gb/products/road-wheels-eu/reds-alloy-wheels/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/reds.png" alt="Reds by Momo" width={90} height={28} className="w-22.5 h-7 object-contain" />
                </a>

                <a href="https://www.ronal-wheels.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/ronal.svg" alt="Ronal" width={90} height={28} className="w-22.5 h-7 object-contain" />
                </a>

                <a href="https://www.rotiform.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center align-middle -translate-y-0.5 mx-2 my-1.5 hover:scale-110 transition-transform">
                    <Image src="/media/logos/rotiform.svg" alt="Rotiform" width={90} height={28} className="w-22.5 h-7 object-contain" />
                </a>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="lg:w-2/3 text-brand-slate text-lg leading-loose">
                    ...
                    <ul className="list-disc pl-5 space-y-3 marker:text-brand-green">
                        ...
                        <li>
                            Általános folyadékszintek ellenőrzése, gyorsdiagnosztika és azonnali hibaelhárítás.
                        </li>
                    </ul>
                </div>
                ...
                <div className="lg:w-1/3">
                    <div className="bg-white rounded-xl p-6 shadow-md border-t-4 border-brand-darkblue">
                        ...
                        <table className="w-full text-brand-slate text-sm lg:text-base">
                            ...
                            <tr>
                                <td className="py-3 pr-2">Gyorsszerviz ellenőrzés</td>
                                <td className="py-3 text-right font-bold text-brand-darkblue whitespace-nowrap">kb. 30 perc</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div className="text-lg text-brand-slate mb-6 leading-loose">
                ...
                <div className="mb-8">
                    ...
                    <a href="https://www.exidegroup.com/" target="_blank" rel="noopener noreferrer" className="relative inline-block h-6 w-20 align-middle -translate-y-0.5 mx-1.5 hover:scale-110 transition-transform">
                        <Image src="/media/logos/exide.svg" alt="Exide" fill sizes="80px" className="object-contain" />
                    </a>
                    <span className="relative inline-block h-6 w-20 align-middle -translate-y-0.5 mx-1.5 hover:scale-110 transition-transform cursor-default">
