...
export default function Home() {
    return (
        <div className="w-full">
            ...
            {/* 2. Időpontfoglalás szekció (Vékonyított kártya, eredeti mintás háttérrel) */}
            <section className="relative py-12 md:py-16 px-4 bg-[url('/media/feherhatter.jpg')] bg-cover bg-center">
                <div className="absolute inset-0 bg-white/40 backdrop-blur-[2px]"></div>
                <div className="relative max-w-5xl mx-auto">
                    <div className="bg-brand-navy rounded-2xl shadow-xl p-6 md:p-10 border border-white/5 relative overflow-hidden group">
            ...
            {/* 3. App szekció (Saját, tiszta CSS/SVG letöltő gombokkal) */}
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
                    ...
                    <div className="w-full md:w-2/3 text-center md:text-left">
                        ...
                        <p className="text-brand-slate text-lg mb-8 max-w-2xl leading-relaxed">
                            Töltse le ingyenes mobilalkalmazásunkat a személyre szabott kiszolgálásért, kényelmes időpontfoglalásért. Értesítések, szerviznapló és akciók – mindig kéznél.
                        </p>
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-4">
                            ...
                            >
                                <svg className="w-8 h-8 text-brand-darkblue group-hover:text-brand-green transition-colors" viewBox="0 0 384 512" fill="currentColor">
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-3 w-56 bg-white border border-brand-lilac/60 px-4 py-3 rounded-xl shadow-sm hover:shadow-md hover:border-brand-green hover:-translate-y-1 transition-all group"
                            >
                                <svg className="w-8 h-8 text-brand-darkblue group-hover:text-brand-green transition-colors" viewBox="0 0 512 512" fill="currentColor">
